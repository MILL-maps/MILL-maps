...
The “Total changes” maps show how many times in the period of 1916-2018 each street was renamed. The numbers vary between 1 (named once and retained the same name throughout the period) to 7.<br>
The “ideology” maps show if the process of (re-)naming of the street was ideological. There are four types of renaming processes which we considered ideological:<br>
